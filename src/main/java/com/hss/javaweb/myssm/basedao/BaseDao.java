package com.hss.javaweb.myssm.basedao;

import com.hss.javaweb.qqzone.utils.JDBCUtil;
...
public class BaseDao<T> {
    ...
    public List<T> getAllBeans(String sql, Class<T> entityClass, Object...parameters) {
        try {
            Connection connection = JDBCUtil.getConnection();
